...
Public Class Copy_2_of_rptPalLabel
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Copy (2) of rptPalLabel.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DeliverySystem.Copy (2) of rptPalLabel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCopy_2_of_rptPalLabel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Copy_2_of_rptPalLabel = New Copy_2_of_rptPalLabel
        rpt.Site = Me.Site
        Return rpt
    End Function
