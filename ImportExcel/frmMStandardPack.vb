...
Public Class frmMStandardPack
    ...
    Private Stdpack, MaxRec As Integer
    Private Filename, tmpFilename, suffix, PartNo, PartName As String
...
MsErr:
    ...
    Sub chkdata()
        ...
        strchk = "select count(*) from Mstdp where spdno='" & PartNo & "' and spchg='" & suffix & "'"
    ...
    Sub updatedata()
        ...
        strsql2 = "update Mstdp set supack='" & Stdpack & "'  where spdno='" & PartNo & "' and spchg='" & suffix & "'  "
    ...
    Sub savedata()
        ...
        strsql = "insert into MSTDP VALUES ( "
        strsql += " '" & PartNo & "', "
        strsql += " '" & suffix & "', "
        strsql += " '" & PartName & "', "
        strsql += " '" & Stdpack & "','','','', "
