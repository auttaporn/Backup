...
Public Class frmMPrice
    ...
    Private Filename, tmpFilename, suffix, PartNo As String
...
MsErr:
    ...
    Sub chkdata()
        ...
        strchk = "select count(*) from MPRICE where mppdno='" & PartNo & "' and mpchg='" & suffix & "' and mpdte='" & EffDate & "'"
    ...
    Sub updatedata()
        ...
        strsql2 = "update MPRICE set mpprc='" & Price & "'  where mppdno='" & PartNo & "' and mpchg='" & suffix & "' and mpdte='" & EffDate & "'  "
    ...
    Sub savedata()
        ...
        strsql = "insert into MPRICE VALUES ( "
        strsql += " '" & PartNo & "', "
        strsql += " '" & suffix & "', "
        strsql += " '" & Price & "', "
        strsql += " '" & EffDate & "', "
    ...
    Private Sub frmMPrice_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        lblTot.Text = ""
    End Sub
End Class
