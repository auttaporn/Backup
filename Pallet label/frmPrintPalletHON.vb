...
Public Class frmPrintPalletHON
    ...
    Private Sub frmPrintPallet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub txtCarton_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtCarton.KeyDown
        ...
        If txtCarton.Text <> "" Then                                    '1
            ...
            If e.KeyCode = Keys.Enter Then                              '2
                ...
                'Select Case cboMaker.SelectedValue.ToString.ToUpper
                '    Case "AAT"
    ...
    Function GetSTDP()
        ...
        strsql = "select *  from mstdp where spdno='" & DPart & "' and spchg='" & DCHG & "' "
        Dim DA As New OleDbDataAdapter(strsql, Comn)
    ...
    Public Sub Redata()
        ...
        strsql += "where pstat='' and  pprefx ='' and pseqno =0 and pmaker='" & cboMaker.Text & "' "
